...
The `r decision$n[1]` (`r decision$p[1]`) patients immediately accepted to critical care had a 7-day mortality of `r icu.dead7$p[2]` (`r icu.dead7$n[2]` deaths). Just `r icu.dead7.pre$n[1]` (`r icu.dead7.pre$p[1]`) of those deaths occurred before admission was arranged, but a further `r icu.icucmp$n[1]` patients (`r icu.icucmp$p[1]`) were never admitted but survived regardless.

Those offered admission were marginally younger (`r age.by.icu$est1` versus `r age.by.icu$est2` years, 95\%CI `r age.by.icu$ci` years), but were distinctly unwell (`r icnarc.by.icu$est1` versus `r icnarc.by.icu$est2` ICNARC physiology points, 95\%CI `r icnarc.by.icu$ci`).
