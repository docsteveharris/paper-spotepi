...
<!-- - [ ] FIXME(2016-02-29):  -->
We also recorded the bedside assessors clinical recommendation for critical care as part of the decision making process. The `r recommend$n[2]` patients (`r recommend$p[2]`) judged as requiring critical care had a 7-day mortality of XXX. Measured physiological severity correlated well with the bedside recommendation (supplementary Figure 3). Nonetheless, critical care was recommended on assessment for XXX NEWS low risk patients, and refused for XXX high risk patients.

 Within the subgroups a recommendation for critical care was associated with XXX relative risk of death, and 
