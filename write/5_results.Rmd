...
Table 1 shows the baseline data for all ward patients assessed. Sepsis was reported in (`r sepsis$n[2]`, `r sepsis$p[2]`\%) patients; of these, the respiratory system was considered to be the source in half (4772, 51\%). Organ failure, defined as a SOFA score greater than or equal to two, was present in 5164 (34\%) of patients. 1427 patients (9\%) were in respiratory failure, 2931 (19\%) were in renal failure, and 4636 (31\%) were shocked. Organ support at the time of assessment was however uncommon (870 patients, 6\%).
