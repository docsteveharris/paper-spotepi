...
Patients declined critical care with treatment limits were older (`r age.by.limits$est2` versus `r age.by.limits$est1` years, 95\%CI for difference `r age.by.limits$ci` years), and more acutely unwell (`r icnarc.by.limits$est2` versus `r icnarc.by.limits$est1` ICNARC physiology points, 95%CI for the difference `r icnarc.by.limits$ci`) than those assigned Ongoing ward care. Critical care occupancy did not affect the proportion of patients declined admission with treatment limits (Table 2).
...
The modelling was repeated but now with the delivery of admission to critical care within 4 hours (a prompt admission) as the outcome, and the decision to admit as an additional predictor (Table 3). In this analysis, we also excluded `r elgthtr$n[3]` (`r elgthtr$p[3]`) patients whose admission was inevitably delayed urgent surgery.
