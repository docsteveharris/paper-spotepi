...
Critical care occupancy did not affect adjusted mortality in the multi-level model (zero beds: hazard ratio 1.03, 95\% confidence interval 0.90 to 1.17). A single level model (supplementary Table 2), constructed in case occupancy was mediated through rather than confounded by the effect of the hospital, similarly could not exclude a null effect (1.07, 1.00 to 1.15).
