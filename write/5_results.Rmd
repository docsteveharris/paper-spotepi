...
There were `r decision$n[3]` patients (`r decision$p[3]`) refused with treatment limits, `r decision$n[2]` patients (`r decision$p[2]`) assigned to active ward-care,  and `r decision$n[1]` patients (`r decision$p[1]`) immediately offered critical care. We used the active ward care group as the control group for all comparisons.
...
These patients were older (`r age.by.limits$est2` vs `r age.by.limits$est1` years, 95\%CI for difference `r age.by.limits$ci` years), and more acutely unwell (`r sofa.by.limits$est2` vs `r sofa.by.limits$est1` SOFA points, 95\%CI for difference `r sofa.by.limits$ci`) than those assigned active ward care. We did not consider these patients further.


### Active ward care

Patients for active ward care had a 7-day mortality of `r ward.dead7$p[2]` (`r ward.dead7$n[2]` deaths). Most deaths (`r ward.dead7.icu$n[1]` deaths `r ward.dead7.icu$p[1]`)  occured on the ward but `r ward.dead7.icu$n[2]` deaths (`r ward.dead7.icu$p[2]`) followed delayed critical care admission. The initial decision to refuse critical care was reversed within a week for `r ward.icucmp$n[2]` patients (`r ward.icucmp$p[2]`), so a total of `r ward.icu.or.dead7$n[2]` (`r ward.icu.or.dead7$p[2]`) patients died or were admitted to critical care.
