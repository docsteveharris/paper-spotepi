...
Critical care teams assessed `r tt$patients` patients of whom `r tt$news_high$n` (`r tt$news_high$p`) were in the highest NEWS risk class giving an incidence of 17 NEWS high risk patients (95\%CI 17--18) per hospital per month. `r odys$n[2]` (`r odys$p[2]`) patients were already in established organ failure with only `r osupp$n[2]` patients (`r osupp$p[2]`) already on organ support. Sepsis was reported in `r sepsis$n[2]` (`r sepsis$p[2]`) patients.
...
Excluding patients with treatment limits, 7-day, 90-day, and 1-year mortalities were `r tt$dead7$p[2]`, `r tt$dead90$p[2]`, and `r tt$dead1y$p[2]` respectively. Mortality occured early with `r tt$dead7.d2$n[2]` of first week deaths (`r tt$dead7.d2$p[2]`) within two days. Survival also varied between hospitals with a median interhospital hazard ratio of 1.29 (95%CI, 1.22--1.35).
