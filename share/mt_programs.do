...
*  =========================================
/*
You could do the same by writing ado files but that would require correct syntax specification.
...
program mt_indent_categorical_vars
	...
	* CHANGED: 2013-05-04 - no longer makes the options smaller as above (old)
