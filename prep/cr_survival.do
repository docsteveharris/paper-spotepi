...
replace dt2 = floor(hours(dt2 - v_timestamp))/24
replace dt3 = floor(hours(dt3 - v_timestamp))/24
replace dt4 = floor(hours(dt4 - v_timestamp))/24
stset dt4, id(id) failure(dead) exit(time dt1+90) origin(time dt1)

* NOTE: 2014-12-11 - [ ] only save if this is the main study data
* This code is also called from cr_sensitivity.do and will otherwise overwrite
* CHANGED: 2015-11-04 - [ ] now saves single survival data
