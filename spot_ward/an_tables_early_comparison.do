...
*  =========================
GenericSetupSteveHarris mas_spotepi an_tables_early_comparison, logon
...
sort bylevel table_order var_level
...
local sub_heading "Parameter & \multicolumn{2}{c}{`sub_heading'} &  \multicolumn{2}{c}{`sub_heading'} \\"
